...
def split_and_save_h5(raw_h5_loadpath, savepath, dataset_name='SW2d', train_frac=0.9, rand = True):
    """
...
class SW2dDataLoader:
    def __init__(self, data_path, dataset_name='SW2d'):
