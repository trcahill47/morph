...
def split_and_save_h5(raw_h5_loadpath, savepath, selected_idx = 0, dataset_name='DR1d', train_frac=0.8, rand = True):
    """
    ...
    with h5py.File(raw_path, 'r') as f_in:
        data = f_in['tensor'][...] # (10000, 101, 1024)
...
class DR1DDataLoader:
    def __init__(self, data_path, dataset_name='DR1d'):
    ...
    def split_train(self, selected_idx):
        ...
        # (10000, 101, 1024) -> (10000, 101, 1, 1, 1024, 1, 1)
